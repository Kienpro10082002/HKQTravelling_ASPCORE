...
namespace HKQTravelling.Migrations
{
    ...
    [Migration("20231030023947_initiation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HKQTravelling.Models.TicketInformations", b =>
                {
                    b.Property<long>("TicketInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HKQTravelling.Models.TicketTypes", b =>
                {
                    b.Property<int>("TicketTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HKQTravelling.Models.Bookings", b =>
                {
                    b.HasOne("HKQTravelling.Models.TicketInformations", "ticketInformations")
                        .WithMany()
                    ...
                    b.Navigation("ticketInformations");
            ...
            modelBuilder.Entity("HKQTravelling.Models.TicketInformations", b =>
                {
                    b.HasOne("HKQTravelling.Models.TicketTypes", "tickeTypes")
                        .WithMany()
